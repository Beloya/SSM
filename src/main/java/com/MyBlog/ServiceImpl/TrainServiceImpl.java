...
public class TrainServiceImpl implements TrainService {
	 ...
	 * @return
	 */
	private String getCLeftTicketUrl(Map<String, Object> postmap) {
	 ...
	 * @return
	 */
	public static String getCLeftTicketUrl(Map<String, Object> postmap, trainRequest trainRequest) {
		String result = null, temp = null, TOKEN = null;
		int n = 0, m = 0;
	...
	public Object requestInit(trainRequest t, String userName) {
		...
		t = (trainRequest) Optional.ofNullable(TrainServiceImpl.sessionTaskGet(userName))
				.orElse(trainRequest.create().custom().useSSL().useMyHeader(true).Builder());
