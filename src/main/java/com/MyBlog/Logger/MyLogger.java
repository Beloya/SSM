...
public class MyLogger {
	 ...
	 * 是否开启Debug
	 */
	public static boolean isDebug =  Logger.getLogger(MyLogger.class).isDebugEnabled();
	...
	public static void error(Class<? extends Object> clazz ,String message,Exception e){
		Logger logger = Logger.getLogger(clazz);
		if(null == e){
			logger.error(LocalDate.now()+"  "+message);
			
			return ;
		}
		logger.error(LocalDate.now()+"  "+message, e);
	...
	public static void error(Class<? extends Object> clazz ,String message){
		error(clazz,LocalDate.now()+"  "+ message, null);
	}
	/**
	 * 异常填充值输出
	 * @param clazz 	目标.Class
