...
public class myStringUtils extends StringUtils{
    ...
    public static String getBASE64(String str,boolean...bf) { 
       if (myStringUtils.isBlank(str)) return null; 
    ...
    public static String strToUrlcode(String value){
    	try {
			...
			MyLogger.error(myStringUtils.class, "字符串转换为URLCode失败,value:" + value,e);
			e.printStackTrace();
			return null;
		}    
    }
    ...
    public static String urlcodeToStr(String value){
    	try {
			...
			MyLogger.error(myStringUtils.class, "URLCode转换为字符串失败;value:" + value,e);
			e.printStackTrace();
			return null;
		}  
    }
	...
	public static List<String> array2Empty(String[] array){
		...
		for (String string : array) {
			if(myStringUtils.isNotBlank(string)){
				list.add(string);
			}
		}
		return list;
