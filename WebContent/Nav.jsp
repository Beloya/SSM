...
<div class="layui-row">
 ...
 <li class="layui-nav-item" id="实验室"><a href="<%=request.getContextPath()%>/Test.htm">实验室</a></li>
...
<shiro:authenticated>
   ...
   <li class="layui-nav-item" lay-unselect="" style="opacity:1; float:right;margin-right:10%;">
    ...
    <dl class="layui-nav-child">
      ...
      <dd><a href="<%=request.getContextPath() %>/Newarchives.html">发布</a></dd>
    </shiro:hasAnyRoles>
...
function LogOut(){
	$.ajax({
		url:'<%=request.getContextPath()%>/LogOut.html',
		type:'post',
...
function QuickLogin(){
  ...
  $.ajax({ 
    	url: "<%=request.getContextPath()%>/QuickLogin.html", 
    	type:'POST',
    	 success: function(result){
    		 if(result.code=="1"){
