...
%>
	<div class="wrapper">
		...
		<div class="content-wrapper"
			...
			<h1>
				<font><font> 评论管理 </font></font><small><font><font></font></font></small>
			</h1>
			<ol class="breadcrumb">
												...
												<tbody>
													...
													<c:forEach items="${informations}" var="list">
														<tr>
															...
															<td class="layui-elip">${list.content}
																	</td>
															...
															<td>
																<div class="layui-btn-group">
																	<button
																		...
																		onclick="deletedata('${list.commentid}');">
...
$("#info_commentManage").addClass("active");
...
, tab: function(pic, layero){
  ...
  function deletedata(commentid){
	  ...
	  layer.confirm('确认删除?', {icon: 3, title:'提示'}, function(index){
		 ...
		 location.href="<%=request.getContextPath() %>/adminfile/infomation/Info_commentDel.html?commentid="+commentid;  	  
		  layer.close(index);
		});
	  }
