...
<body>
	...
	<nav class="pagination">
						...
						<a class="extend prev" rel="prev" href="<%=request.getContextPath() %>/time_axis_${pager.prePage}">
					...
					<c:if test="${pager.pages<=5}">
												<c:forEach var="i" begin="1" end="${pager.pages}">
													...
													<c:if test="${page!=pager.page }">
														<a class="page-numbers"
															href="<%=request.getContextPath() %>/time_axis_${page}">${page}</a>
													</c:if>
												</c:forEach>
											</c:if>
							<c:if test="${pager.pages>5 }">
														...
														<c:choose>
															<c:when test="${pager.page+2<pager.pages}">
																...
																<c:forEach var="i" begin="${page }"
																	...
																	<c:if test="${page==pager.page-2 }">
																		...
																		<a class="page-numbers"
																			href="<%=request.getContextPath() %>/time_axis_1">1</a>
																		<a class="page-numbers" href="">....</a>
																	</c:if>
																	...
																	<c:if test="${page==pager.page+2 }">
																		<a class="page-numbers" href="">....</a>
																		<a class="page-numbers"
																			href="<%=request.getContextPath() %>/time_axis_${pager.pages}">${pager.pages}</a>
															...
															<c:when test="${pager.page+2>=pager.pages}">
																...
																<c:forEach var="i" begin="${page }" end="${pager.pages}">
																	<c:if test="${page==pager.page-2 }">
																		<a class="page-numbers"
																			href="<%=request.getContextPath() %>/time_axis_1">首页</a>
																		<a class="page-numbers"
																			href="<%=request.getContextPath() %>/time_axis_1">1</a>
																		<a class="page-numbers" href="">....</a>
																	</c:if>
						...
						<a class="extend next" rel="next" href="<%=request.getContextPath() %>/time_axis_${pager.nextPage}"><i
