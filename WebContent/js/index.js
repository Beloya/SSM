...
var colors = [{ main: '#FFFFFF', shades: ['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF'] }, { main: '#FFFFFF', shades: ['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF'] }, { main: '#FFFFFF', shades: ['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF'] }, { main: '#FFFFFF', shades: ['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF'] }, { main: '#FFFFFF', shades: ['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF'] }, { main: '#FFFFFF', shades: ['#FFFFFF', '#FFFFFF', '#FFFFFF', 'FFFFFF'] }, { main: '#FFFFFF', shades: ['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF'] }];
...
var positionLetters = function positionLetters() {
  ...
  letters.forEach(function (letter) {
    ...
    TweenLite.to(letter.onScreen, timing, { x: letter.offScreen.offsetLeft+i-20 + 'px', ease: Power3.easeInOut+i });
    letter.shift = true;
    i+=20;
  });
};
...
var onInputChange = function onInputChange() {
  var value = input.value === '' ? [] : input.value.split('');
  addLetters(value);
  removeLetters(value);
  resizeLetters();
};
...
if(document.getElementById("canvas")!=null&&document.getElementById("canvas")!="null"){
var Rope = function () {
	function Rope(rope) {
